...
# bar plot
barplot(m_wd_b_nb,
        main = "Avg. Shares on Weekend:Business vs. Non-Business Articles",
        ylab = "Average No. of Shares",
        xlab = "Type of Article",
        ylim = c(0,4000),
        col = colors()[237],
        names.arg = c("Business", "Non-Business"))
```
<b>Description:</b>This plot shows how the average number of shares vary with the type of the article. Similar to the conclusion from the plot above, we can see that there is no significant difference in the average number of shares between business and non-business articles. This result is contrary to our assumption that people are less likely to share business related artices on weekends.
<br><br>
...
qplot(num_images, numshare,data = Q2_data, xlab = "Number of Images in an Article", ylab = "Number of Shares(x10000)", main = "#images in an article with respect to number of shares", xlim = c(0, 100), ylim = c(0,20), alpha = I(1/10), geom = c("point", "smooth"),width = 100)
qplot(number_of_words, numshare, data = Q2_data, xlab = "Number of Words in an Article", ylab = "Number of Shares (x10000)", main = "#words in an article with respect to number of shares", xlim = c(0, 7000), ylim = c(0,15), alpha = I(1/10), geom = c("point", "smooth"))

```
<b>Description:</b>This graph  the trend of the number of images in an article along with the number of shares of that article. We can interpret from the trend line that there is a slight relation between number of images and the number of shares. The articles with images in the range of 10-30 have a higher number of shares. The second graph shows the trend of the number of words in an article along with the number of shares of that article.We can interpret from the trend line that there is no specific relationship between the number of shares and the number of words.
...
```
<b>Description:</b>This plot shows the average number of shares for articles with an image and without an image respectively. We can interpret from this graph that the average number of shares of an article with NO IMAGE is higher (4395.779) and with an IMAGE is lower (3181.344)
