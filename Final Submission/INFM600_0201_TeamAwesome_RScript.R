...
OriginalData <- read.csv("C:/INFM600/OnlineNewsPopularity-R.csv")
...
# Performing Linear Regression on the two IV's - number of images and number of words
m1 = lm(shares~num_images)
summary(m1) #We get the p-value of 4.23e-15 which is lower than the significance value of 0.05
#This means that there is a significant relationship between number of images and number of shares

m2 = lm(shares~number_of_words)
summary(m2) #We get the p-value of 0.62 which is higher than the significance value of 0.05
#This means that there is NO significant relationship between number of words in an artcile and the number of shares
